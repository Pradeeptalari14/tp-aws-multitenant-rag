# 🔧 Troubleshooting Guide — Multi-Tenant RAG with Metadata Filtering (AWS)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-aws-multitenant-rag/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/aws-multitenant-rag/)
